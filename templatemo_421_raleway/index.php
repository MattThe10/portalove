				...
				<div class="col-md-8">
					<nav id="nav" class="main-navigation hidden-xs hidden-sm">
						<ul class="main-menu">
							...
							<li><a class="show-3 projectbutton" href="#">Posts</a></li>
	...
	<div id="menu-container">
		...
		<div id="menu-3" class="content project-section container">
			<div class="projects-header">
				<h2 class="animated fadeInRight">Latest posts</h2>
			</div>
		...
		<div id="menu-4" class="content blog-section container">
			<div class="blog-header text-center">
				...
				<a href="postForm.php" class="blog-button animated fadeInUp">continue journal</a>
			</div>
					...
					<div class="col-md-6 col-sm-12">
						<div class="contact-form animated fadeInUp">
							...
							<div class="row">
								...
								<fieldset class="col-md-6">
									<input type="text" name="priezvisko" placeholder="Surname">
								</fieldset>
								<fieldset class="col-md-12">
									<input type="text" name="predmet" placeholder="Subject">
								</fieldset>
								<fieldset class="col-md-12">
									<textarea name="sprava" id="sprava" cols="30" rows="10" placeholder="Message"></textarea>
								</fieldset>
								<fieldset class="col-md-12">
									<button type="submit" id="submitForm" class="message-button">Submit Message</button>
								</fieldset>
							</div>
						</div>
					</div>
